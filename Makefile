...
# Modules files
build/modules/%.o: source/implementation/modules/%.c
	mkdir -p $(dir $@)
	$(CC) -static -c -I source/include -ffreestanding $(patsubst build/modules/%.o, source/implementation/modules/%.c, $@) -o $@
...
build-x86_64: $(kernel_object_files) $(x86_64_object_files) $(libraries_object_files) $(modules_object_files)
	...
	$(LD) -n -o distro/x86_64/kernel.bin -T targets/x86_64/linker.ld $(kernel_object_files) $(x86_64_object_files) $(libraries_object_files) $(modules_object_files)
