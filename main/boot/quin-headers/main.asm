...
section .bss
align 4096
page_table_l4:resb 4096			; 4096 bytes for 1 table
page_table_l3:resb 4096			; 4096 bytes for 1 table
page_table_l2:resb 4096 * 4		; 4 tables of 4096 bytes each
stack_bottom: resb 4096 * 16 	; 64KB stack
stack_top:
